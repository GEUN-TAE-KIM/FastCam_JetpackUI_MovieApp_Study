package kr.rmsxo.movieapp.ui.components.dialog.components.content
...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val ratingBackgroundColor = MaterialTheme.colorScheme.onPrimaryContainer.copy(
                alpha = 0.05f
            ).toArgb()

            // 제트팩이 아닌 것을 제트팩으로 사용 할 수 있게 해주는게 AndroidView
            AndroidView(
                modifier = Modifier
                    .wrapContentWidth()
