...
import kr.rmsxo.movieapp.features.common.entity.MovieFeedItemEntity
import kr.rmsxo.movieapp.features.feed.presentation.input.IFeedViewModelInput
import kr.rmsxo.movieapp.ui.theme.Paddings
import kr.rmsxo.movieapp.ui.theme.labelLargeBold

val CARD_WIDTH = 150.dp
val ICON_SIZE = 12.dp
...
fun MovieItem(
    ...
    Column(
        ...
        Text(
            ...
            style = MaterialTheme.typography.labelLargeBold
        )
        Row(
            modifier = Modifier.padding(
